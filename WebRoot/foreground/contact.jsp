...
<!-- start menu -->
<link href="/AntMoviesForeground/foreground/css/megamenu.css" rel="stylesheet" type="text/css" media="all" />
...
<link rel="stylesheet" href="/AntMoviesForeground/foreground/css/font-awesome.min.css" />
<link rel="stylesheet" href="/AntMoviesForeground/foreground/css/menu.css" />
...
<body>
  ...
  <div class="modal-dialog">
	...
	<!---pop-up-box---->  
					<link href="/AntMoviesForeground/foreground/css/popuo-box.css" rel="stylesheet" type="text/css" media="all"/>
	...
	<div class="bootstrap_container">
            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <!-- Mega Menu -->
					<li class="dropdown w3_megamenu-fw"><a href="/AntMoviesForeground/foreground/movie_schedule.jsp" class="dropdown-toggle">电影排期<b class="caret"></b></a>
...
<!-- AddThis Smart Layers END -->
	...
	<!----->
	<div class="contact">
	<p class="love">我们聆听你的看法</p>
	<div class="contact-form">
					<div class="col-md-6 contact-grid">
					<form>
						<p class="your-para">您的姓名:</p>
						<input type="text" value="" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
						<p class="your-para">您的Email:</p>
						<input type="text" value="" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
						<p class="your-para">您的反馈信息:</p>
				...
				<div class="col-md-6 contact-in">
					<p class="sed-para"> Ant 影视城的信息一览</p>
					<p class="para1">
						Ant影城位于成都市最繁华的郫县，拥有着老影院不可攀比的时尚格调和高雅风情以及无比真实、震撼的观影效果。全力打造，殿堂享受
凯瑞国际影城总经营面积高达2200平方米，严格按照国际影城标准设计和配置。影城秉承国际影院的时尚风格，装修豪华，高雅大方，拥有6个视听效果一流、温馨舒适的观映厅，其中普通影厅4个，3D影厅2个，共设796个豪华舒适座椅。
					</p>
