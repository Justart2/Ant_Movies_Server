...
*/
	...
	*/
	$(document).ready(function () {
		...
		$(".movie_imges a").lightBox();
		//.colorbox({opacity:0,rel:'movie_imge',title:false});
...
function createChart(){
	var inputTotalNum = '<input type="text" id="totalNum" data-thickness=".35" data-readOnly=true data-width="140" data-height="140" data-max="20" data-min="0" data-style="margin-left:63px;"/>';
	$('.appraise_pie_chart .knob-wrap').remove();
	$('.appraise_pie_chart').prepend(inputTotalNum);
	var likeDisplayNum = 20;//‘影片详情页-评价图表’和‘首页-影片喜欢率’的阀值
